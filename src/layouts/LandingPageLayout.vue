<template lang="pug">
  q-layout.landing__body(view="hHh lpR fff")
    .row.landing__container.justify-center
      .col-6.full-height.gt-md
        vue-particles.full-height(
          color="#dedede"
          shapeType="edge"
          :particleSize="10"
          :particlesNumber="35")
      .landing__hero.col-12.col-sm-10.col-md-6.shadow-2.full-height
        q-page-container
          landing-page
